                        ...
                        <div className='LEFT-PART col-span-2'>
                            <div className='BOX-1 border-b border-gray-100 pb-16'>
                                <div className=' bg-[#F9F3F0] p-12 pb-16 rounded-md border-l-[6px] border-[#FAB8C4] pr-24 '>
                                    ...
                                    <div className='mt-14'>
                                        <Link to="/Standard Post" href="#" className=" relative px-10 py-5 z-10 rounded-md font-semibold  text-white bg-[#3577F0] 
                                 before:absolute 
                                 before:content-[''] 
                                 before:rounded-md 
                                 before:left-0 
                            ...
                            <div className='BOX-4 border-b border-gray-100 py-16'>
                                ...
                                <div>
                                    ...
                                    <p className='text-base text-gray-500 leading-7'>Donec metus lorem, vulputate at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. Aliquam tristique libero at dui sodales, et placerat orci lobortis. Maecenas ipsum neque, elementum id dignissim et, imperdiet vitae mauris.</p>
                                    <div className='mt-14'>
                                        <Link to="/Video Post" href="#" className=" relative px-10 py-5 z-10 rounded-md font-semibold  text-white bg-[#3577F0] 
                                            before:absolute 
                                            before:content-[''] 
                                            before:rounded-md 
                                            before:left-0 
                            ...
                            <div className='BOX-5 pt-16'>
                                <div className='mb-10'>
                                    <div className='relative group'>
                                        <Link to="/Gallery Post" href="#"><img className='rounded-lg w-full cursor-auto' src="../src/assets/blog/blog-list/asset 7.png" alt="" /></Link>
                                ...
                                <div>
                                    ...
                                    <div className='mt-14'>
                                        <Link to="/Gallery Post" href="#" className=" relative px-10 py-5 z-10 rounded-md font-semibold  text-white bg-[#3577F0] 
                                            before:absolute 
                                            before:content-[''] 
                                            before:rounded-md 
                                            before:left-0 
